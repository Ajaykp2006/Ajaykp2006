...
*   🔭 **Building:** Interactive Cartesian grids to visualize matrix mathematics (Translation, Rotation, Scaling, Reflection).
*   🧮 **Deep Diving:** Partial differential equations, Operations Research, and mathematical optimization (Simplex Method, LPP).
*   ⚙️ **Exploring:** The core mechanics of Operating Systems, process scheduling, and software testing methodologies.
